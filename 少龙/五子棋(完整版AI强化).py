		...
		for j in range(len(qipan[i])):
			try:
				if qipan[i][j] != '.':
					continue
				#拦截对手决胜
				if qipan[i][j+1] == 'X' and qipan[i][j+2] == 'X' and qipan[i][j+3] == 'X' and qipan[i][j+4] == 'X' and qipan[i][j+5] == 'O':#横
					qipan[i][j] = f
					return
		...
		for j in range(len(qipan[i])):
			try:
				if qipan[i][j] != '.':
					continue
				#拦截对手
				if qipan[i][j+1] == 'X' and qipan[i][j+2] == 'X' and qipan[i][j+3] == 'X':#横
					qipan[i][j] = f
					return
	...
	for i in range(len(qipan)):
		for j in range(len(qipan[i])):
			try:
				...
				if qipan[i][j] != '.':
					continue
				if (qipan[i][j+1] == 'O' and qipan[i][j+2] == 'O'and qipan[i][j+3] == 'O'and qipan[i][j+4] == 'O') or (qipan[i][j+1] == 'O' and qipan[i][j+2] == 'O'and qipan[i][j+3] == 'O') or (qipan[i][j+1] == 'O' and qipan[i][j+2] == 'O') or (qipan[i][j+1] == 'O'):#横
					qipan[i][j] = f
					return
		...
		for j in range(len(qipan[i])):
			try:
				if qipan[i][j] != '.':
					continue
				#拦截对手决胜
				if qipan[i][j+1] == 'O' and qipan[i][j+2] == 'O' and qipan[i][j+3] == 'O' and qipan[i][j+4] == 'O' and qipan[i][j+5] == 'X':#横
					qipan[i][j] = f
					return
		...
		for j in range(len(qipan[i])):
			try:
				if qipan[i][j] != '.':
					continue
				#拦截对手
				if qipan[i][j+1] == 'O' and qipan[i][j+2] == 'O' and qipan[i][j+3] == 'O':#横
					qipan[i][j] = f
					return
		...
		for j in range(len(qipan[i])):
			try:
				if qipan[i][j] != '.':
					continue
				#决胜
				if (qipan[i][j+1] == 'X' and qipan[i][j+2] == 'X'and qipan[i][j+3] == 'X'and qipan[i][j+4] == 'X') or (qipan[i][j+1] == 'X' and qipan[i][j+2] == 'X'and qipan[i][j+3] == 'X') or (qipan[i][j+1] == 'X' and qipan[i][j+2] == 'X') or (qipan[i][j+1] == 'X'):#横
					qipan[i][j] = f
					return
